...
Dos 200 repositórios analisados, ~100 PRs geraram métricas válidas. Medianas (todos PRs):
- Tempo de análise: 9.5 horas
- Arquivos alterados: 1
- Linhas totais: 20
- Descrição: 761 caracteres
- Interações (comentários): 0
- Participantes: 3
- Revisões: 2
- Taxa de merge: 80%

**Exemplo de PR (freeCodeCamp/freeCodeCamp #62660):** Tempo=2.4h, Linhas=2, Merged=True.
...
![Tamanho vs Merge](../img/scatter_tamanho_vs_merge.png)
![Tempo vs Merge](../img/scatter_tempo_vs_merge.png)
![Descrição vs Merge](../img/scatter_descricao_vs_merge.png)
![Interações vs Merge](../img/scatter_interacoes_vs_merge.png)
![Tamanho vs Revisões](../img/scatter_tamanho_vs_revisoes.png)
![Tempo vs Revisões](../img/scatter_tempo_vs_revisoes.png)
![Descrição vs Revisões](../img/scatter_descricao_vs_revisoes.png)
![Interações vs Revisões](../img/scatter_interacoes_vs_revisoes.png)
