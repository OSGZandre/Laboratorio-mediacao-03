...
Dos ~10 repositórios analisados, ~100 PRs geraram métricas válidas. Medianas (todos PRs):
...
**Gráficos:** scatter_tamanho_vs_merge.png, etc., mostrando dispersão sem tendência clara.
